...
from .views import PostsView, PostDetailsView, NewsCreateView, PostEditView, PostDeleteView, ArticleCreateView
...
news_patterns = [
    ...
    path('<int:pk>/edit/', PostEditView.as_view(), name='news_update'),
    path('<int:pk>/delete/', PostDeleteView.as_view(), name='news_delete'),
]

article_patterns = [
    path('create/', ArticleCreateView.as_view(), name='article_create'),
    path('<int:pk>/edit/', PostEditView.as_view(), name='article_update'),
